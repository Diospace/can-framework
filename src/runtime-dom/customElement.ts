import { effect, ReactiveEffect, reactive, EffectScope, proxyRefs, watch } from '../reactivity/index';
...
export class CanElement extends GlobalHTMLElement {
    constructor() {
        ...
        (this as any)._can_id = Math.random().toString(36).slice(2, 11);
    ...
    static get observedAttributes(): string[] {
        ...
        const definitions = (this as any).propDefinitions;
